...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-slate-900 text-slate-300 relative overflow-hidden border-t-2 border-amber-400">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-8 pb-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-6">
          ...
          <div className="space-y-3">
            <Link to="/" className="inline-block p-2 rounded-xl bg-white shadow-md hover:opacity-95 transition-opacity" title="EuroKids Balwant Nagar">
              <img
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-2xl overflow-hidden border border-slate-700 shadow-md bg-slate-800 h-36 w-full relative">
              <iframe
        ...
        {/* Key Points Trust Strip: in a single line to save vertical space */}
        <div className="py-2.5 px-3 sm:px-4 rounded-xl bg-slate-800/80 border border-slate-700/60 flex flex-wrap items-center justify-between gap-3 text-xs font-semibold text-slate-300 mb-6">
          ...
          <div className="inline-flex items-center gap-1.5 text-amber-400">
            <ShieldCheck className="w-3.5 h-3.5 shrink-0" />
            <span>TÜV Certified Centre</span>
          </div>
